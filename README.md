...
- 每一段路線提供公里數補登／更新欄位；輸入限制為 0.1–999 KM，更新既有距離前需再次確認。人工值只寫入既有里程 localStorage 資料層，不改巡店 Sheet、GAS、登入／Session 或原始到店紀錄。2026-08-27「台北通化→台北萬大」9.6 KM 已列為人工確認受控距離，當日「台北三創→台北通化→台北萬大」合計 13.2 KM。
