...
- 做了什麼：以最新 `origin/main` 為正式程式基準，保留本機已驗證的
  ...
  `../AI協作中心/00_WEBSITE_INDEX.md` 與三站 `PROJECT_HANDOFF.md`。
...
- 經驗 / 給下一位的提醒：正式接手先讀 `../AI協作中心/00_WEBSITE_INDEX.md`，
  再讀目標站 `PROJECT_HANDOFF.md`。下方 2026-07-25 的紅色區塊是歷史故障快照，
  不可取代最新交接文件；正式部署、GAS 線上版本與 Liam 驗收仍須各自取得證據。

## ⚠️ 歷史故障快照（2026-07-25；現況以正式交接文件為準）
