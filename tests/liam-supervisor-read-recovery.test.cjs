...
test('recovery release is cache-busted and formal half-month write remains disabled', () => {
  assert.match(html, /app\.js\?v=personal-award-main-20260819-1/);
  assert.match(sw, /liam-supervisor-app-1-2-personal-award-main-20260819-v1/);
  assert.match(app, /service-worker\.js\?v=personal-award-main-20260819-1/);
